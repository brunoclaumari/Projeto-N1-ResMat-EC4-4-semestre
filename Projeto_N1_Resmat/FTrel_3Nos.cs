...
{
    public partial class FTrel_3Nos : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string[] vetorNomeForcas = { "HA", "VA", "VB", "AB", "AC", "CB" };

                //double pontas = 0;
                if (double.Parse(txtAltura.Text) <= 0 || double.Parse(txtAB.Text) <= 0)
                {
                    MessageBox.Show("A distância AB e a altura devem ser maior que 0");
                    return;
                }
                ...
                TracaoOuCompressao(c.matrizForcas[5, 0], txtForcaBC);
                if (temErro)
                    return;
