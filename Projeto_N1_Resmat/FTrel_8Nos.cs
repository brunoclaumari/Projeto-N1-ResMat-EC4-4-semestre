...
{
    public partial class FTrel_8Nos : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Ponto H
                forcaNosPontos[14] = ValidaDouble(txtFHH);
                forcaNosPontos[15] = ValidaDouble(txtFHV);
                ...
                string[] vetorNomeForcas = { "HA", "VA", "VE", "AB", "AF", "BF", "BC", "FC",
                                             "CH", "CG", "CD","DG","DE","GE","FH","HG"};

                //double pontas = 0;
                if (double.Parse(txtAltura.Text) <= 0 || double.Parse(txtAE.Text) <= 0)
                {
                    MessageBox.Show("A distância AE e a altura devem ser maior que 0");
                    return;
                }

                //else if (double.Parse(txtAltura.Text) < double.Parse(txtAE.Text))
                else
                {
                    ...
                    bMaior = ValidaDouble(txtAE);
                    bQuat = bMaior / 4;
                    altura = ValidaDouble(txtAltura);
                    meiaAltura = altura / 2;

                    //angulo ang1 é o angulo FÂB, FBC, GCD e GED
                    ang1 = c.CalculaAngulo(meiaAltura, bQuat);
                    ...
                    no.OrdemDoNo = 'F';
                    no.coordX = bQuat;
                    no.coordY = meiaAltura;
                    listaDeNos.Add(no);

                    no = new Nos();
                    no.OrdemDoNo = 'G';
                    no.coordX = bMaior - bQuat;
                    no.coordY = meiaAltura;
                    listaDeNos.Add(no);
                    ...
                    InstanciaBarras("AF", listaDeNos);
                    InstanciaBarras("BF", listaDeNos);
                    InstanciaBarras("BC", listaDeNos);
                    InstanciaBarras("FC", listaDeNos);
                    InstanciaBarras("CH", listaDeNos);
                    InstanciaBarras("CG", listaDeNos);
                    InstanciaBarras("CD", listaDeNos);
                    InstanciaBarras("DG", listaDeNos);
                    InstanciaBarras("DE", listaDeNos);
                    InstanciaBarras("GE", listaDeNos);
                    InstanciaBarras("FH", listaDeNos);
                    InstanciaBarras("HG", listaDeNos);
                    ...
                    lblAngA.Text = lblAngB.Text = lblAngC.Text = lblAngD.Text =
                        ang1.ToString("F3") + "°";
                ...
                TracaoOuCompressao(c.matrizForcas[4, 0], txtForcaAF);
                TracaoOuCompressao(c.matrizForcas[5, 0], txtForcaBF);
                TracaoOuCompressao(c.matrizForcas[6, 0], txtForcaBC);
                TracaoOuCompressao(c.matrizForcas[7, 0], txtForcaCF);
                TracaoOuCompressao(c.matrizForcas[8, 0], txtForcaCH);
                TracaoOuCompressao(c.matrizForcas[9, 0], txtForcaCG);
                TracaoOuCompressao(c.matrizForcas[10, 0], txtForcaCD);
                TracaoOuCompressao(c.matrizForcas[11, 0], txtForcaDG);
                TracaoOuCompressao(c.matrizForcas[12, 0], txtForcaDE);
                TracaoOuCompressao(c.matrizForcas[13, 0], txtForcaGE);
                TracaoOuCompressao(c.matrizForcas[14, 0], txtForcaFH);
                TracaoOuCompressao(c.matrizForcas[15, 0], txtForcaHG);
        ...
        private void cbHV_CheckedChanged(object sender, EventArgs e)
        {
            txtFHV.Text = MudaSinalTexto(txtFHV.Text, cbHV);
        }
        ...
        private void cbHH_CheckedChanged(object sender, EventArgs e)
        {
            txtFHH.Text = MudaSinalTexto(txtFHH.Text, cbHH);
        }
