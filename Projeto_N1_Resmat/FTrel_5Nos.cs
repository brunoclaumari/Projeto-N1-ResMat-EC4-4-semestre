...
{
    public partial class FTrel_5Nos : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string[] vetorNomeForcas = { "HA", "VA", "VC", "AB", "AD", "DB", "DE", "BE", "BC", "EC" };

                //double pontas = 0;
                if (double.Parse(txtAltura.Text) <= 0 || double.Parse(txtAC.Text) <= 0)
                {
                    MessageBox.Show("A distância AC, a distância AB e a altura devem ser maior que 0");
                    return;
                }
                else if (double.Parse(txtDE.Text) > double.Parse(txtAC.Text))
                {
                    MessageBox.Show("A distância DE deve ser menor que a distância AC");
                    return;
                }

                //else if (double.Parse(txtAltura.Text) < double.Parse(txtAC.Text))
                else
                {
                    ...
                    bMaior = ValidaDouble(txtAC);
                    bMenor = ValidaDouble(txtDE);
                    pontaFora = (bMaior - bMenor) / 2;
                    pontaDentro = bMenor / 2;
                    ...
                    InstanciaBarras("AD", listaDeNos);
                    InstanciaBarras("DB", listaDeNos);
                    InstanciaBarras("DE", listaDeNos);
                    InstanciaBarras("BE", listaDeNos);
                    InstanciaBarras("BC", listaDeNos);
                    InstanciaBarras("EC", listaDeNos);
                    ...
                    lblAng1A.Text = ang1.ToString("F3") + "°";
                    lblAng1B.Text = lblAng1A.Text;
                    lblAng2A.Text = lblAng2B.Text = ang2.ToString("F3") + "°";
                ...
                TracaoOuCompressao(c.matrizForcas[4, 0], txtForcaAD);
                TracaoOuCompressao(c.matrizForcas[5, 0], txtForcaBD);
                TracaoOuCompressao(c.matrizForcas[6, 0], txtForcaDE);
                TracaoOuCompressao(c.matrizForcas[7, 0], txtForcaBE);
                TracaoOuCompressao(c.matrizForcas[8, 0], txtForcaBC);
                TracaoOuCompressao(c.matrizForcas[9, 0], txtForcaCE);
                if (temErro)
                    return;
